...
//#region node_modules/.nitro/vite/services/ssr/assets/rutas._slug-DowVPp3B.js
var ROUTE_PAGES = [
	{
		slug: "costa-blanca",
		metaTitle: {
		...
		heroSubtitle: {
			es: "Un itinerario costero para la primera autocaravana: calas escondidas, pueblos blancos y mercados de pescado al pie del puerto.",
			en: "A coastal route for your first campervan trip: hidden coves, white villages and fresh fish markets by the harbour.",
			de: "Eine Küstenroute für die erste Wohnmobilreise: versteckte Buchten, weiße Dörfer und Fischmärkte am Hafen.",
			it: "Un itinerario costiero per il primo viaggio in camper: calette nascoste, borghi bianchi e mercati del pesce al porto.",
			nl: "Een kustroute voor de eerste camperreis: verborgen baaien, witte dorpjes en versvismarkten bij de haven.",
			ru: "Прибрежный маршрут для первого путешествия на автодоме: укромные бухты, белые городки и рынки со свежей рыбой у причала.",
			uk: "Прибережний маршрут для першої подорожі на автодімі: приховані бухти, білі містечка і ринки зі свіжою рибою біля пристані."
		},
		intro: {
		...
		days: [
			...
			},
			{
				...
				text: {
					es: "Por la mañana, breve trayecto a Dénia por la N-332, una de las carreteras costeras más bonitas. El castillo de Dénia domina la ciudad, el barrio pescador Baix la Mar conserva el alma marinera, y en el mercado municipal encontrarás la famosa gamba roja de Dénia. Tras comer, 15 minutos hasta Jávea. Nosotros paramos siempre en el Wecamp Jávea — buen camping a un precio razonable. Reserva en reservations.wecamp.net. Truco: online en temporada alta piden mínimo 3 noches, pero en recepción puedes quedarte 1-2 si hay sitio; llama al +34 936 268 900 para confirmar. Al atardecer, sube al mirador del Cap de Sant Antoni — acantilados de 160 metros sobre el mar. Consejo local: las famosas Cala Moraig y Cala Granadella están en todas las guías, pero NO las recomendamos en autocaravana — los accesos son estrechos con curvas cerradas, y en temporada alta es imposible aparcar o maniobrar.",
					en: "A short morning drive to Dénia along the N-332, one of the most scenic coastal roads. Dénia's castle presides over the town, the fishing quarter Baix la Mar retains its seafaring soul, and the municipal market sells the famous red prawn (gamba roja) of Dénia. After lunch, 15 minutes to Jávea. We always stop at Wecamp Jávea — a good campsite at a fair price. Book at reservations.wecamp.net. One thing to know: online booking in high season requires a 3-night minimum, but the reception desk will take 1-2-night stays if space allows — call +34 936 268 900 to check. At sunset, climb to the Cap de Sant Antoni viewpoint — 160-metre cliffs above the sea. Local tip: the famous Cala Moraig and Cala Granadella appear in every guidebook, but we do NOT recommend them for a motorhome — the access roads are narrow with tight bends, and in high season it is impossible to park or turn around.",
					de: "Morgens kurze Fahrt nach Dénia auf der N-332, einer der schönsten Küstenstraßen. Das Schloss von Dénia überragt die Stadt, das Fischerviertel Baix la Mar bewahrt seinen maritimen Charakter, und auf dem Stadtmarkt gibt es die berühmte rote Garnele aus Dénia. Nach dem Mittagessen 15 Minuten weiter nach Jávea. Wir halten immer im Wecamp Jávea — ein guter Campingplatz zu einem fairen Preis. Buchung unter reservations.wecamp.net. Hinweis: Online-Buchungen in der Hauptsaison erfordern mindestens 3 Naechte; an der Rezeption sind aber 1-2 Naechte moeglich, wenn Plaetze frei sind — vorher anrufen: +34 936 268 900. Bei Sonnenuntergang lohnt sich der Aussichtspunkt Cap de Sant Antoni — 160 Meter hohe Klippen über dem Meer. Geheimtipp: Die berühmten Calas Moraig und Granadella stehen in jedem Reiseführer, aber wir empfehlen sie für Wohnmobile NICHT — die Zufahrten sind eng und kurvenreich, in der Hauptsaison ist Parken oder Wenden unmöglich.",
					it: "Breve spostamento mattutino verso Dénia lungo la N-332, una delle strade costiere più belle. Il castello di Dénia domina la città, il quartiere peschereccio Baix la Mar conserva la sua anima marinara, e al mercato comunale si trovano i celebri gamberoni rossi di Dénia. Dopo pranzo, 15 minuti fino a Jávea. Noi ci fermiamo sempre al Wecamp Jávea — un buon campeggio a un prezzo onesto. Prenotate su reservations.wecamp.net. Nota pratica: le prenotazioni online in alta stagione richiedono almeno 3 notti, ma alla reception si puo' chiedere per 1-2 notti se ci sono posti liberi — telefonate al +34 936 268 900 per verificare. Al tramonto, salite al belvedere del Cap de Sant Antoni — scogliere di 160 metri sul mare. Consiglio locale: le famose Cala Moraig e Cala Granadella compaiono in tutte le guide, ma NON le raccomandiamo con il camper — gli accessi sono stretti con curve strette, e in alta stagione è impossibile parcheggiare o fare inversione.",
					nl: "Een korte ochtendrit naar Dénia via de N-332, een van de mooiste kustroutes. Het kasteel van Dénia domineert de stad, de vissersbuurt Baix la Mar ademt een maritieme sfeer, en op de gemeentemarkt vind je de beroemde rode garnaal uit Dénia. Na de lunch, 15 minuten naar Jávea. Wij stoppen altijd bij Wecamp Jávea — een goede camping voor een eerlijke prijs. Boeken via reservations.wecamp.net. Let op: online boeken in het hoogseizoen vereist minimaal 3 nachten, maar aan de receptie kan het ook voor 1-2 nachten als er plek is — bel +34 936 268 900 om te checken. Bij zonsondergang is het uitkijkpunt Cap de Sant Antoni de moeite waard — kliffen van 160 meter boven de zee. Lokale tip: de beroemde Cala Moraig en Cala Granadella staan in alle reisgidsen, maar we raden ze NIET aan voor een camper — de toegangswegen zijn smal met scherpe bochten, en in het hoogseizoen is parkeren of keren onmogelijk.",
					ru: "Утром — короткий переезд в Дению по N-332, одной из красивейших прибрежных дорог. Замок Дении возвышается над городом, рыбацкий квартал Baix la Mar хранит морской дух, а на муниципальном рынке продают знаменитую красную креветку из Дении. После обеда — 15 минут до Хавеи. Мы часто останавливаемся в Wecamp Jávea — отличный кемпинг за разумную цену. Бронирование: reservations.wecamp.net. Лайфхак: онлайн-бронирование в высокий сезон требует минимум 3 ночи, но на ресепшн можно заселиться на 1-2 ночи при наличии мест — звоните +34 936 268 900 для уточнения. На закате поднимитесь на смотровую Cap de Sant Antoni — 160-метровые обрывы над морем. Совет от местных: знаменитые Cala Moraig и Cala Granadella есть во всех путеводителях, но мы НЕ рекомендуем их на автодоме — подъезды узкие, с крутыми поворотами, в высокий сезон невозможно припарковаться или развернуться.",
					uk: "Вранці — короткий переїзд до Денії по N-332, одній з найкрасивіших прибережних доріг. Замок Денії височіє над містом, рибальський квартал Baix la Mar зберігає морський дух, а на муніципальному ринку продають знамениту червону креветку з Денії. Після обіду — 15 хвилин до Хавеї. Ми часто зупиняємось у Wecamp Jávea — чудовий кемпінг за розумну ціну. Бронювання: reservations.wecamp.net. Лайфхак: онлайн-бронювання у високий сезон вимагає мінімум 3 ночі, але на ресепшн можна заселитись на 1-2 ночі за наявності місць — дзвоніть +34 936 268 900 для уточнення. На заході сонця піднімайтесь на оглядовий майданчик Cap de Sant Antoni — 160-метрові обриви над морем. Порада від місцевих: знамениті Cala Moraig і Cala Granadella є в усіх путівниках, але ми НЕ рекомендуємо їх на автодімі — під'їзди вузькі, з крутими поворотами, у високий сезон неможливо припаркуватись або розвернутись."
				}
			},
			{
			...
			},
			{
				...
				text: {
					...
					de: "Ein Tag für Geheimstrände. Zwischen Benidorm und Villajoyosa versteckt sich Racó de Conill — eine Bucht mit kristallklarem Wasser, ohne Bar oder Musik. Früh ankommen lohnt sich. Ein Teil der Bucht ist FKK-Zone, die Atmosphäre ist überall ruhig. Mit Kindern unterwegs? Wir empfehlen den Aqualandia Wasserpark in Benidorm (aqualandiabenidorm.com) — Tickets online sind guenstiger als an der Kasse. Am Nachmittag: Playa Paradís in Villajoyosa — goldener Sand, flaches Wasser für Kinder, deutlich weniger Betrieb als in Benidorm. Villajoyosa überrascht mit seinen bunten Häusern am Meer und der Schokoladenfabrik Valor mit kostenlosem Museum und Verkostung. Übernachtung: Stellplatz Villajoyosa, 5 Gehminuten zum Strand.",
					...
					nl: "Een dag voor geheime stranden. Tussen Benidorm en Villajoyosa verstopt zich Racó de Conill — een baai met kristalhelder water, zonder bar of muziek. Kom vroeg. Een deel van de baai is naturistenzone; de sfeer is overal rustig. Reizen jullie met kinderen? Wij raden Aqualandia waterpark in Benidorm aan (aqualandiabenidorm.com) — online tickets zijn goedkoper dan aan de kassa. 's Middags: Playa Paradís in Villajoyosa — goudkleurig zand, ondiep water voor kinderen en veel minder mensen dan in Benidorm. Villajoyosa verrast met zijn kleurrijke huizen aan zee en de chocoladefabriek Valor met een gratis museum en proeverij. Overnachting: camperplaats Villajoyosa, 5 minuten lopen naar het strand.",
					ru: "День секретных пляжей. Между Бенидормом и Вильяхойосой прячется Racó de Conill — бухта с кристально чистой водой без чирингито и музыки. Приезжайте пораньше. Часть бухты — зона натуристов, атмосфера спокойная. Путешествуете с детьми? Наша рекомендация — аквапарк Aqualandia в Бенидорме (aqualandiabenidorm.com). Билеты онлайн дешевле, чем на входе. Во второй половине дня — Playa Paradís в Вильяхойосе: золотой песок, мелководье для детей, гораздо меньше людей, чем в Бенидорме. Вильяхойоса удивляет разноцветными домами у моря и шоколадной фабрикой Valor с бесплатным музеем и дегустацией. Ночёвка: площадка Вильяхойосы, 5 минут пешком до пляжа.",
	...
	},
	{
		slug: "andalucia",
		metaTitle: {
			es: "Ruta Autocaravana Andalucia desde Valencia: Sur de Espana en 10-12 Dias | Camper Retreat VLC",
			en: "Campervan Route through Andalusia from Valencia: Southern Spain in 10-12 Days | Camper Retreat VLC",
			de: "Wohnmobil-Route durch Andalusien ab Valencia: Suedspanien in 10-12 Tagen | Camper Retreat VLC",
			it: "Itinerario Camper in Andalusia da Valencia: Spagna del Sud in 10-12 Giorni | Camper Retreat VLC",
			nl: "Camperroute door Andalusie vanuit Valencia: Zuid-Spanje in 10-12 Dagen | Camper Retreat VLC",
		...
		metaDescription: {
			es: "Ruta autocaravana andalucia desde Valencia en 10-12 dias: Granada, Alhambra, Alpujarra, Ronda, cabo de gata autocaravana y Cartagena. Viajar en autocaravana por andalucia con guia completa de areas. Desde 99 euros/noche.",
			...
			de: "Wohnmobil-Route durch Andalusien ab Valencia in 10-12 Tagen: Granada, Alhambra, Alpujarra, Ronda, Cabo de Gata und Cartagena. Vollstaendiger Reisefuehrer fuer Suedspanien. Ab 99 Euro/Nacht.",
			...
			nl: "Camperroute door Andalusie vanuit Valencia in 10-12 dagen: Granada, Alhambra, Alpujarra, Ronda, Cabo de Gata en Cartagena. Complete gids voor Zuid-Spanje. Vanaf 99 euro/nacht.",
		...
		heroTitle: {
			es: "Ruta autocaravana Andalucia: de Valencia al sur de Espana en 10-12 dias",
			en: "Andalusia Campervan Route: Valencia to Southern Spain in 10-12 Days",
			de: "Andalusien per Wohnmobil: Von Valencia in den Sueden Spaniens in 10-12 Tagen",
			it: "Percorso Camper in Andalusia: da Valencia al Sud della Spagna in 10-12 Giorni",
			nl: "Camperroute door Andalusie: Van Valencia naar Zuid-Spanje in 10-12 Dagen",
		...
		heroSubtitle: {
			es: "La Alhambra al amanecer, pueblos blancos en los acantilados, el unico desierto de Europa y playas a las que solo llegan los que saben — el sur de Espana fue creado para la autocaravana.",
			en: "The Alhambra at dawn, white villages on the cliffs, Europe's only desert and beaches that only those in the know reach — southern Spain was made for a motorhome.",
			de: "Die Alhambra im Morgengrauen, weisse Doerfer auf den Felsen, die einzige Wueste Europas und Straende, zu denen nur Eingeweihte gelangen — Suedspanien ist gemacht fuer das Wohnmobil.",
			it: "L'Alhambra all'alba, borghi bianchi sulle scogliere, l'unico deserto d'Europa e spiagge raggiungibili solo da chi sa dove andare — il sud della Spagna e' fatto per il camper.",
			nl: "De Alhambra bij het ochtendgloren, witte dorpen op de kliffen, de enige woestijn van Europa en stranden die alleen de ingewijden bereiken — Zuid-Spanje is gemaakt voor de camper.",
			ru: "Альгамбра на рассвете, белые деревни на скалах, единственная пустыня Европы и пляжи, до которых доезжают только свои — юг Испании создан для дома на колёсах.",
			uk: "Альгамбра на світанку, білі села на скелях, єдина пустеля Європи і пляжі, до яких добираються лише свої — південь Іспанії створений для будинку на колесах."
		},
		intro: {
			es: "Andalucia es la Espana que uno imagina: palacios moros, gargantas con casas blancas y sol casi todo el ano. Los circuitos en autobus cubren Granada y Sevilla; la autocaravana llega tambien a las calas salvajes del Cabo de Gata, a los serpentines de la Alpujarra y a los pueblos pesqueros donde el tiempo se detuvo. La ruta discurre en circuito por Granada, Ronda, la costa de Malaga y de vuelta a lo largo del mar por Almeria y Cartagena. Unos 1400 km a ritmo tranquilo, con dias de descanso en playas. Viajar en autocaravana por andalucia — la mejor forma de ver la otra cara del sur. Mejor epoca: abril-junio y septiembre-octubre; en verano los dias calurosos del circuito se pasan junto al mar.",
			en: "Andalusia is the Spain of the imagination: Moorish palaces, gorges lined with white houses and sunshine most of the year. Bus tours cover Granada and Seville; a motorhome also reaches the wild coves of Cabo de Gata, the mountain switchbacks of the Alpujarra and the fishing villages where time stood still. The route runs in a loop through Granada, Ronda, the Malaga coast and back along the sea via Almeria and Cartagena. Around 1,400 km at a relaxed pace, with rest days on beaches. Best time: April to June and September to October; in summer the hot inland days are spent at the coast.",
			de: "Andalusien ist das Spanien, das man sich vorstellt: maurische Palaeste, Schluchten mit weissen Haeusern und Sonne fast das ganze Jahr. Bustouren fahren Granada und Sevilla an; das Wohnmobil erreicht auch die wilden Buchten des Cabo de Gata, die Gebirgsserpentinen der Alpujarra und die Fischerdoerfer, in denen die Zeit stehen blieb. Die Route fuehrt im Rundkurs durch Granada, Ronda, die Kueste von Malaga und entlang des Meeres zurueck ueber Almeria und Cartagena. Rund 1.400 km in entspanntem Tempo, mit Ruhetagen am Strand. Beste Reisezeit: April bis Juni und September bis Oktober; im Sommer verbringt man die heissen Binnentage am Meer.",
			it: "L'Andalusia e' la Spagna che si immagina: palazzi moreschi, gole con case bianche e sole quasi tutto l'anno. I tour in pullman coprono Granada e Siviglia; il camper raggiunge anche le calette selvagge del Cabo de Gata, i tornanti delle Alpujarras e i villaggi di pescatori dove il tempo si e' fermato. Il percorso si svolge in circolo attraverso Granada, Ronda, la costa di Malaga e di ritorno lungo il mare via Almeria e Cartagena. Circa 1.400 km a ritmo rilassato, con giorni di riposo sulle spiagge. Periodo migliore: aprile-giugno e settembre-ottobre; d'estate le giornate calde dell'entroterra si trascorrono in riva al mare.",
			nl: "Andalusie is het Spanje dat men zich voorstelt: Moorse paleizen, kloven met witte huizen en zon bijna het hele jaar. Bustouren doen Granada en Sevilla aan; een camper bereikt ook de wilde baaien van Cabo de Gata, de bergwegen van de Alpujarra en de vissersdorpen waar de tijd heeft stilgestaan. De route loopt in een lus door Granada, Ronda, de kust van Malaga en langs de zee terug via Almeria en Cartagena. Ongeveer 1.400 km in een rustig tempo, met rustdagen op stranden. Beste tijd: april tot juni en september tot oktober; in de zomer brengt men de hete dagen op het platteland door aan de kust.",
			ru: "Андалусия — это Испания, которую воображают: мавританские дворцы, ущелья с белыми домами и почти круглогодичное солнце. Автобусные туры охватывают Гранаду и Севилью; автодом добирается также до диких бухт Cabo de Gata, горных серпантинов Альпухарры и рыбацких деревень, где время остановилось. Маршрут построен кольцом через Гранаду, Ронду, побережье Малаги и обратно вдоль моря через Альмерию и Картахену. Около 1400 км в спокойном темпе, с днёвками на пляжах. Лучшее время: апрель-июнь и сентябрь-октябрь; летом жаркие дни маршрут проводит у моря.",
			uk: "Андалусія — це Іспанія, яку уявляють: мавританські палаци, ущелини з білими будинками і майже цілорічне сонце. Автобусні тури охоплюють Гранаду та Севілью; автодім добирається також до диких бухт Cabo de Gata, гірських серпантинів Альпухарри і рибальських сіл, де час зупинився. Маршрут побудований кільцем через Гранаду, Ронду, узбережжя Малаги і назад вздовж моря через Альмерію та Картахену. Близько 1400 км у спокійному темпі, з денними зупинками на пляжах. Найкращий час: квітень-червень і вересень-жовтень; влітку спекотні дні маршрут проводить біля моря."
		},
		days: [
			{
				photoSlot: "dia-1-granada",
				title: {
					es: "Dia 1: Valencia — Granada (500 km)",
				...
				text: {
					es: "El tramo mas largo del circuito, primero deliberadamente, cuando hay mas energia. Por la A-7 y la A-92 a traves de Murcia, 5 horas con una parada para comer. Al atardecer, a los pies de Sierra Nevada. Lo mas importante: comprad las entradas a la Alhambra con 2-4 semanas de antelacion en el sitio oficial — es el monumento mas visitado de Espana, y las entradas no se consiguen en taquilla. Noche: Camping Reina Isabel (La Zubia), a 15 minutos en autobus del centro, o area de autocaravanas Granada.",
					en: "The longest leg of the loop, deliberately placed first when there is most energy. Via the A-7 and A-92 through Murcia, 5 hours with a lunch stop. By evening you are at the foot of the Sierra Nevada. Most important: buy Alhambra tickets 2-4 weeks in advance on the official website — it is the most visited monument in Spain and there are no tickets at the door. Overnight: Camping Reina Isabel (La Zubia), 15 minutes by bus from the centre, or area de autocaravanas Granada.",
					de: "Die laengste Etappe des Rundkurses, bewusst als erste geplant, wenn noch die meiste Energie vorhanden ist. Ueber A-7 und A-92 durch Murcia, 5 Stunden mit Mittagsstopp. Am Abend seid ihr am Fuss der Sierra Nevada. Am wichtigsten: Kauft die Alhambra-Tickets 2-4 Wochen im Voraus auf der offiziellen Website — es ist das meistbesuchte Denkmal Spaniens, und an der Kasse gibt es keine Tickets. Uebernachtung: Camping Reina Isabel (La Zubia), 15 Minuten mit dem Bus vom Zentrum, oder Area de Autocaravanas Granada.",
					it: "La tappa piu' lunga del circuito, deliberatamente messa per prima quando l'energia e' al massimo. Tramite A-7 e A-92 attraverso Murcia, 5 ore con sosta pranzo. Al tramonto siete ai piedi della Sierra Nevada. La cosa piu' importante: acquistate i biglietti per l'Alhambra con 2-4 settimane di anticipo sul sito ufficiale — e' il monumento piu' visitato della Spagna e non ci sono biglietti alla cassa. Pernottamento: Camping Reina Isabel (La Zubia), 15 minuti in autobus dal centro, o area camper Granada.",
					nl: "Het langste deel van de lus, bewust als eerste gepland wanneer er het meeste energie is. Via A-7 en A-92 door Murcia, 5 uur met een lunchstop. 's Avonds ben je aan de voet van de Sierra Nevada. Het belangrijkste: koop Alhambra-tickets 2-4 weken van tevoren op de officiele website — het is het meest bezochte monument van Spanje en er zijn geen kaartjes aan de kassa. Overnachting: Camping Reina Isabel (La Zubia), 15 minuten met de bus van het centrum, of area de autocaravanas Granada.",
			...
			},
			{
				...
				title: {
					es: "Dia 2: Granada — un dia entero",
				...
				text: {
					es: "Un dia entero para una de las grandes ciudades del mundo. Manana — Alhambra (3-4 horas): palacios Nazaries, jardines del Generalife, fortaleza Alcazaba. Tomad el turno mas temprano — menos gente y luz suave. Tarde — Albaicin, el barrio morisco de las colinas y las casas blancas: perderse aqui es lo mejor que podeis hacer. Atardecer — mirador de San Nicolas: la Alhambra con el tlon de fondo de las cumbres nevadas de Sierra Nevada, llegad con una hora de antelacion. Noche — tapas: Granada es la ultima ciudad de Espana donde la tapa a la copa es gratuita. Calle Navas y barrio Realejo.",
					en: "A full day for one of the great cities of the world. Morning — Alhambra (3-4 hours): Nasrid palaces, Generalife gardens, Alcazaba fortress. Take the earliest slot — fewer people and soft light. Afternoon — Albaicin, the Moorish hilltop quarter with white houses: getting lost here is the best thing you can do. Sunset — San Nicolas viewpoint: the Alhambra against the snow-capped peaks of the Sierra Nevada, arrive an hour early. Evening — tapas: Granada is the last city in Spain where a tapa comes free with every drink. Calle Navas and the Realejo quarter.",
					de: "Ein ganzer Tag fuer eine der grossen Staedte der Welt. Morgens — Alhambra (3-4 Stunden): Nasriden-Palaeste, Generalife-Gaerten, Festung Alcazaba. Nehmt den fruehesten Eintrittsslot — weniger Menschen und weiches Licht. Nachmittags — Albaicin, das maurische Huegelviertel mit weissen Haeusern: sich hier zu verlaufen ist das Schoenste, was ihr tun koennt. Sonnenuntergang — Aussichtspunkt San Nicolas: die Alhambra vor den schneebedeckten Gipfeln der Sierra Nevada, kommt eine Stunde frueher. Abends — Tapas: Granada ist die letzte Stadt Spaniens, in der eine Tapa zum Getraenk gratis ist. Calle Navas und Viertel Realejo.",
					it: "Un'intera giornata per una delle grandi citta' del mondo. Mattina — Alhambra (3-4 ore): palazzi Nasridi, giardini del Generalife, fortezza Alcazaba. Prendete lo slot piu' mattutino — meno gente e luce morbida. Pomeriggio — Albaicin, il quartiere moresco sulle colline con case bianche: perdersi qui e' la cosa migliore che possiate fare. Tramonto — belvedere San Nicolas: l'Alhambra sullo sfondo delle cime innevate della Sierra Nevada, arrivate con un'ora di anticipo. Sera — tapas: Granada e' l'ultima citta' della Spagna dove la tapa con la consumazione e' gratuita. Calle Navas e quartiere Realejo.",
					nl: "Een volle dag voor een van de grote steden van de wereld. Ochtend — Alhambra (3-4 uur): Nasridische paleizen, tuinen van het Generalife, vesting Alcazaba. Neem het vroegste tijdslot — minder mensen en zacht licht. Middag — Albaicin, de Moorse heuvels met witte huizen: hier verdwalen is het beste wat je kunt doen. Zonsondergang — uitkijkpunt San Nicolas: de Alhambra tegen de besneeuwde toppen van de Sierra Nevada, kom een uur eerder. Avond — tapas: Granada is de laatste stad in Spanje waar een tapas bij je drankje gratis is. Calle Navas en de wijk Realejo.",
					ru: "Целый день на один из великих городов мира. Утро — Альгамбра (3-4 часа): дворцы Насридов, сады Хенералифе, крепость Алькасаба. Берите самый ранний слот — меньше людей и мягкий свет. День — Альбайсин, мавританский квартал холмов и белых домов: заблудиться здесь — лучшее, что можно сделать. Закат — смотровая Сан-Николас: Альгамбра на фоне снежных вершин Сьерра-Невады, приходите за час. Вечер — тапас: Гранада — последний город Испании, где тапа к напитку подаётся бесплатно. Улица Navas и квартал Realejo.",
					uk: "Цілий день на одне з великих міст світу. Ранок — Альгамбра (3-4 години): палаци Насридів, сади Хенераліфе, фортеця Алькасаба. Беріть найранніший слот — менше людей і м'яке світло. День — Альбайсин, мавританський квартал пагорбів і білих будинків: заблукати тут — найкраще, що можна зробити. Захід — оглядовий майданчик Сан-Ніколас: Альгамбра на тлі засніжених вершин Сьєрра-Невади, приходьте за годину. Вечір — тапас: Гранада — останнє місто Іспанії, де тапа до напою подається безкоштовно. Вулиця Navas і квартал Realejo."
				}
			},
			{
				photoSlot: "dia-3-alpujarra",
				title: {
					es: "Dia 3: Granada — Alpujarra — Orgiva (90 km)",
					en: "Day 3: Granada — Alpujarra — Orgiva (90 km)",
					de: "Tag 3: Granada — Alpujarra — Orgiva (90 km)",
					it: "Giorno 3: Granada — Alpujarra — Orgiva (90 km)",
					nl: "Dag 3: Granada — Alpujarra — Orgiva (90 km)",
					ru: "День 3: Гранада — Альпухарра — Оргива (90 км)",
					uk: "День 3: Гранада — Альпухарра — Оргіва (90 км)"
				},
				text: {
					es: "Etapa corta en kilometros, pero intensa en las montanas. La Alpujarra son las laderas sur de Sierra Nevada, donde se refugiaron los ultimos moriscos tras la Reconquista. Pueblos blancos del barranco de Poqueira: Pampaneira, Bubion, Capileira — tres pueblos uno sobre otro, tejidos locales y queso de cabra. Trevelez — el pueblo mas alto de Espana (1476 m) y cuna del mejor jamon serrano. Carretera: la A-4132 es estrecha pero practicable con nuestro Yearling sin prisa — en los pueblos, aparcad a la entrada. Noche: Camping Orgiva en el valle con piscina y vistas a las montanas.",
					en: "Short in kilometres, intense in the mountains. The Alpujarra is the southern slopes of the Sierra Nevada, where the last Moors retreated after the Reconquista. White villages of the Poqueira gorge: Pampaneira, Bubion, Capileira — three villages one above the other, local weaving and goat's cheese. Trevelez — the highest village in Spain (1,476 m) and home to the finest serrano ham. Road: the A-4132 is narrow but passable in our Yearling without rushing — in the villages, park at the entrance. Overnight: Camping Orgiva in the valley with a pool and mountain views.",
					de: "Kurz an Kilometern, intensiv in den Bergen. Die Alpujarra sind die Suedabhaenge der Sierra Nevada, wo die letzten Mauren nach der Reconquista Zuflucht fanden. Weisse Doerfer der Poqueira-Schlucht: Pampaneira, Bubion, Capileira — drei Doerfer uebereinander, lokale Webwaren und Ziegenkaese. Trevelez — das hoechste Dorf Spaniens (1.476 m) und Heimat des besten Serrano-Schinkens. Strasse: die A-4132 ist schmal, aber mit unserem Yearling ohne Eile befahrbar — in den Doerfern am Ortseingang parken. Uebernachtung: Camping Orgiva im Tal mit Pool und Bergblick.",
					it: "Corta in chilometri, intensa in montagna. Le Alpujarras sono i versanti meridionali della Sierra Nevada, dove si rifugiarono gli ultimi moreschi dopo la Reconquista. Borghi bianchi della gola di Poqueira: Pampaneira, Bubion, Capileira — tre borghi uno sull'altro, tessuti locali e formaggio di capra. Trevelez — il borgo piu' alto della Spagna (1.476 m) e culla del miglior prosciutto serrano. Strada: la A-4132 e' stretta ma percorribile con il nostro Yearling senza fretta — nei borghi, parcheggiate all'ingresso. Pernottamento: Camping Orgiva nella valle con piscina e vista sulle montagne.",
					nl: "Kort in kilometers, intensief in de bergen. De Alpujarra zijn de zuidelijke hellingen van de Sierra Nevada, waar de laatste Moren zich na de Reconquista terugtrokken. Witte dorpen van de Poqueira-kloof: Pampaneira, Bubion, Capileira — drie dorpen boven elkaar, lokale weefsels en geitenkaas. Trevelez — het hoogste dorp van Spanje (1.476 m) en thuisbasis van de beste serrano-ham. Weg: de A-4132 is smal maar begaanbaar met onze Yearling zonder haast — in de dorpen parkeren aan de ingang. Overnachting: Camping Orgiva in het dal met zwembad en bergzicht.",
					ru: "Короткий по километрам, но насыщенный день в горах. Альпухарра — южные склоны Сьерра-Невады, куда после Реконкисты ушли последние мориски. Белые деревни ущелья Poqueira: Pampaneira, Bubion, Capileira — три деревни одна над другой, местные ткани и козий сыр. Trevelez — самая высокогорная деревня Испании (1476 м) и родина лучшего хамона серрано. Дорога: серпантин A-4132 узкий, но проезжаемый на нашем Yearling спокойно — в деревнях паркуйтесь на въезде. Ночёвка: Camping Orgiva в долине с бассейном и видом на горы.",
					uk: "Короткий за кілометрами, але насичений день у горах. Альпухарра — південні схили Сьєрра-Невади, куди після Реконкісти пішли останні мориски. Білі села ущелини Poqueira: Pampaneira, Bubion, Capileira — три села одне над одним, місцеві тканини і козячий сир. Trevelez — найвисокогірніше село Іспанії (1476 м) і батьківщина найкращого хамону серрано. Дорога: серпантин A-4132 вузький, але проїзний на нашому Yearling спокійно — у селах паркуйтесь на в'їзді. Ночівля: Camping Orgiva у долині з басейном і видом на гори."
				}
			},
			{
				photoSlot: "dia-4-ronda",
				title: {
					es: "Dia 4: Orgiva — Ronda (180 km)",
					en: "Day 4: Orgiva — Ronda (180 km)",
					de: "Tag 4: Orgiva — Ronda (180 km)",
					it: "Giorno 4: Orgiva — Ronda (180 km)",
					nl: "Dag 4: Orgiva — Ronda (180 km)",
					ru: "День 4: Оргива — Ронда (180 км)",
					uk: "День 4: Оргіва — Ронда (180 км)"
				},
				text: {
					es: "Traslado a la ciudad mas dramatica de Espana. Ronda se alza en los dos bordes de la garganta del Tajo de 120 metros de profundidad, unidos por el Puente Nuevo. Bajad por el sendero Camino de los Molinos — 20 minutos de descenso, y entendreis por que habeis venido: la vista del puente desde el fondo del tajo merece todo el viaje. Ademas del puente: el coso mas antiguo de Espana, el paseo por el borde del tajo y el atardecer desde la plataforma Aldehuela. Noche: area de autocaravanas Ronda, a 10 minutos a pie del centro.",
					en: "Transfer to the most dramatic city in Spain. Ronda stands on the two edges of the 120-metre-deep Tajo gorge, joined by the Puente Nuevo. Descend the Camino de los Molinos trail — 20 minutes down and you will understand why you came: the view of the bridge from the gorge floor is worth the whole trip. Beyond the bridge: Spain's oldest bullring, a walk along the edge of the gorge and the sunset from the Aldehuela platform. Overnight: area de autocaravanas Ronda, 10 minutes' walk from the centre.",
					de: "Fahrt zur dramatischsten Stadt Spaniens. Ronda thront an den beiden Raendern der 120 Meter tiefen Schlucht Tajo, verbunden durch die Puente Nuevo. Geht den Weg Camino de los Molinos hinab — 20 Minuten bergab, und ihr versteht, warum ihr hergefahren seid: der Blick auf die Bruecke vom Schluchtboden ist die ganze Reise wert. Neben der Bruecke: die aelteste Stierkampfarena Spaniens, ein Spaziergang am Schluchtenrand und der Sonnenuntergang von der Plattform Aldehuela. Uebernachtung: Area de Autocaravanas Ronda, 10 Gehminuten vom Zentrum.",
					it: "Trasferimento alla citta' piu' drammatica della Spagna. Ronda si erge sui due bordi della gola del Tajo profonda 120 metri, collegati dal Puente Nuevo. Scendete lungo il sentiero Camino de los Molinos — 20 minuti di discesa e capirete perche' siete venuti: la vista del ponte dal fondo della gola vale tutto il viaggio. Oltre al ponte: la piazza taurina piu' antica della Spagna, una passeggiata sul bordo della gola e il tramonto dalla piattaforma Aldehuela. Pernottamento: area camper Ronda, a 10 minuti a piedi dal centro.",
					nl: "Transfer naar de meest dramatische stad van Spanje. Ronda staat op de twee kanten van de 120 meter diepe Tajo-kloof, verbonden door de Puente Nuevo. Daal af via het pad Camino de los Molinos — 20 minuten omlaag en je begrijpt waarom je bent gekomen: het uitzicht op de brug vanuit de kloof is de hele reis waard. Naast de brug: de oudste stierenvechtarena van Spanje, een wandeling langs de rand van de kloof en de zonsondergang vanaf het platform Aldehuela. Overnachting: area de autocaravanas Ronda, 10 minuten lopen van het centrum.",
					ru: "Переезд к самому драматичному городу Испании. Ронда стоит на двух краях ущелья Tajo глубиной 120 метров, соединённых мостом Puente Nuevo. Спуститесь по тропе Camino de los Molinos — 20 минут вниз, и вы поймёте, зачем ехали: вид на мост из ущелья стоит всей поездки. Кроме моста: старейшая арена корриды Испании, прогулка по кромке ущелья, закат с площадки Aldehuela. Ночёвка: area de autocaravanas Ronda, 10 минут пешком до центра.",
					uk: "Переїзд до найдраматичнішого міста Іспанії. Ронда стоїть на двох краях ущелини Tajo глибиною 120 метрів, з'єднаних мостом Puente Nuevo. Спустіться стежкою Camino de los Molinos — 20 хвилин вниз, і ви зрозумієте, навіщо їхали: вид на міст з ущелини вартий всієї поїздки. Крім мосту: найстаріша арена кориди Іспанії, прогулянка по краю ущелини, захід сонця з майданчика Aldehuela. Ночівля: area de autocaravanas Ronda, 10 хвилин пішки до центру."
				}
			},
			{
				photoSlot: "dia-5-setenil-malaga",
				title: {
					es: "Dia 5: Ronda — pueblos blancos — Malaga (130 km)",
					en: "Day 5: Ronda — white villages — Malaga (130 km)",
					de: "Tag 5: Ronda — weisse Doerfer — Malaga (130 km)",
					it: "Giorno 5: Ronda — borghi bianchi — Malaga (130 km)",
					nl: "Dag 5: Ronda — witte dorpen — Malaga (130 km)",
					ru: "День 5: Ронда — белые деревни — Малага (130 км)",
					uk: "День 5: Ронда — білі села — Малага (130 км)"
				},
				text: {
					es: "Por la manana, la ruta de los pueblos blancos: Setenil de las Bodegas, donde las casas estan construidas directamente en la roca (las calles-cueva Cuevas del Sol), y Zahara de la Sierra sobre el embalse turquesa. Al atardecer, bajada al mar en Malaga: el museo Picasso en la ciudad donde nacio, la fortaleza Alcazaba y el paseo maritimo Muelle Uno. Noche: area Malaga (Huelin) o Camping Torremolinos.",
					en: "Morning, the white-villages route: Setenil de las Bodegas, where houses are built directly into the rock (the cave streets Cuevas del Sol), and Zahara de la Sierra above its turquoise reservoir. At dusk, a descent to the sea at Malaga: the Picasso Museum in the city of his birth, the Alcazaba fortress and the Muelle Uno waterfront. Overnight: area Malaga (Huelin) or Camping Torremolinos.",
					de: "Morgens die weissen Doerfer: Setenil de las Bodegas, wo die Haeuser direkt in den Fels gebaut sind (die Hoehlenstrassen Cuevas del Sol), und Zahara de la Sierra ueber dem tuerkisfarbenen Stausee. Am Abend Abstieg ans Meer nach Malaga: das Picasso-Museum in der Geburtsstadt des Kuenstlers, die Festung Alcazaba und die Uferpromenade Muelle Uno. Uebernachtung: Area Malaga (Huelin) oder Camping Torremolinos.",
					it: "Mattina, la ruta dei borghi bianchi: Setenil de las Bodegas, dove le case sono costruite direttamente nella roccia (le strade-grotta Cuevas del Sol), e Zahara de la Sierra sopra il lago turchese. Al tramonto, discesa verso il mare a Malaga: il museo Picasso nella citta' della sua nascita, la fortezza Alcazaba e il lungomare Muelle Uno. Pernottamento: area Malaga (Huelin) o Camping Torremolinos.",
					nl: "Ochtend, de route van witte dorpen: Setenil de las Bodegas, waar de huizen rechtstreeks in de rots zijn gebouwd (de grotsstraten Cuevas del Sol), en Zahara de la Sierra boven het turquoise stuwmeer. Bij schemering, afdaling naar de zee in Malaga: het Picasso-museum in zijn geboortestad, de vesting Alcazaba en de kade Muelle Uno. Overnachting: area Malaga (Huelin) of Camping Torremolinos.",
					ru: "Утром — дорога белых деревень: Setenil de las Bodegas, где дома встроены прямо в скалу (улицы-пещеры Cuevas del Sol), и Zahara de la Sierra над бирюзовым водохранилищем. К вечеру — спуск к морю в Малагу: музей Пикассо в городе его рождения, крепость Алькасаба, набережная Muelle Uno. Ночёвка: area Malaga (Huelin) или Camping Torremolinos.",
					uk: "Вранці — дорога білих сіл: Setenil de las Bodegas, де будинки вбудовані прямо в скелю (вулиці-печери Cuevas del Sol), і Zahara de la Sierra над бірюзовим водосховищем. До вечора — спуск до моря в Малагу: музей Пікассо в місті його народження, фортеця Алькасаба, набережна Muelle Uno. Ночівля: area Malaga (Huelin) або Camping Torremolinos."
				}
			},
			{
				photoSlot: "dia-6-cabo-de-gata",
				title: {
					es: "Dias 6-7: Malaga — Nerja — Cabo de Gata (220 km)",
					en: "Days 6-7: Malaga — Nerja — Cabo de Gata (220 km)",
					de: "Tage 6-7: Malaga — Nerja — Cabo de Gata (220 km)",
					it: "Giorni 6-7: Malaga — Nerja — Cabo de Gata (220 km)",
					nl: "Dagen 6-7: Malaga — Nerja — Cabo de Gata (220 km)",
					ru: "Дни 6-7: Малага — Нерха — Кабо-де-Гата (220 км)",
					uk: "Дні 6-7: Малага — Нерха — Кабо-де-Гата (220 км)"
				},
				text: {
					es: "Hacia el este por la costa. Parada en Nerja: el Balcon de Europa sobre el mar y las cuevas con el mayor estalactita del mundo. Mas adelante — la joya principal del sureste: el parque natural Cabo de Gata-Nijar, el unico desierto de Europa que llega hasta el mar. Rocas volcanicas, cactus, playas sin un solo edificio — aqui se rodaron los westerns. Imprescindible: Playa de los Genoveses (salvaje bahia en media luna), Playa Monsul (rocas negras y la duna de Indiana Jones), el faro de Cabo de Gata y el mirador de los arrecifes Arrecife de las Sirenas al atardecer. Base: el pueblo de San Jose. Importante: en verano (15 jun - 15 sep) el acceso en coche a las playas esta restringido — dejad el autocaravana en San Jose y coged el shuttle. Noche: Camping Cabo de Gata o area Los Escullos. Dos noches minimo — este es el lugar por el que se alquila una autocaravana.",
					en: "East along the coast. Stop at Nerja: the Balcon de Europa above the sea and the caves with the world's largest stalactite. Then — the star of the south-east: Cabo de Gata-Nijar natural park, Europe's only desert that meets the sea. Volcanic rocks, cacti, beaches without a single building — this is where they filmed the spaghetti westerns. Not to miss: Playa de los Genoveses (a wild crescent bay), Playa Monsul (black rocks and the Indiana Jones dune), the Cabo de Gata lighthouse and the Arrecife de las Sirenas reef viewpoint at sunset. Base: the village of San Jose. Important: in summer (15 Jun - 15 Sep) car access to the beaches is restricted — leave the motorhome in San Jose and take the shuttle. Overnight: Camping Cabo de Gata or area Los Escullos. Two nights minimum — this is the place people hire a motorhome for.",
					de: "Nach Osten entlang der Kueste. Halt in Nerja: der Balcon de Europa ueber dem Meer und die Hoehlen mit dem weltgroessten Stalaktiten. Dann — das Highlight des Suedostens: der Naturpark Cabo de Gata-Nijar, die einzige Wueste Europas, die ans Meer grenzt. Vulkanfelsen, Kakteen, Straende ohne ein einziges Gebaeude — hier wurden die Spaghettiwestern gedreht. Unbedingt sehen: Playa de los Genoveses (wilde Halbmond-Bucht), Playa Monsul (schwarze Felsen und die Indiana-Jones-Duene), der Leuchtturm von Cabo de Gata und der Arrecife de las Sirenas Riffblick bei Sonnenuntergang. Basis: das Dorf San Jose. Wichtig: im Sommer (15. Jun - 15. Sep) ist die Anfahrt zu den Straenden eingeschraenkt — lasst das Wohnmobil in San Jose und nehmt den Shuttle. Uebernachtung: Camping Cabo de Gata oder Area Los Escullos. Mindestens zwei Naechte — das ist der Ort, wegen dem man ein Wohnmobil mietet.",
					it: "A est lungo la costa. Fermata a Nerja: il Balcon de Europa sul mare e le grotte con la stalattite piu' grande del mondo. Poi — la perla del sud-est: il parco naturale Cabo de Gata-Nijar, l'unico deserto d'Europa che incontra il mare. Rocce vulcaniche, cactus, spiagge senza un solo edificio — qui giravano i western. Da non perdere: Playa de los Genoveses (selvaggia baia a mezzaluna), Playa Monsul (rocce nere e la duna di Indiana Jones), il faro di Cabo de Gata e il belvedere sulle scogliere Arrecife de las Sirenas al tramonto. Base: il villaggio di San Jose. Importante: d'estate (15 giu - 15 set) l'accesso in auto alle spiagge e' limitato — lasciate il camper a San Jose e prendete la navetta. Pernottamento: Camping Cabo de Gata o area Los Escullos. Minimo due notti — questo e' il posto per cui si noleggia un camper.",
					nl: "Naar het oosten langs de kust. Stop in Nerja: de Balcon de Europa boven de zee en de grotten met de grootste stalactiet ter wereld. Dan — de hoofdparel van het zuidoosten: het natuurpark Cabo de Gata-Nijar, de enige woestijn van Europa die de zee raakt. Vulkanische rotsen, cactussen, stranden zonder een enkel gebouw — hier werden de spaghettiwesterns gedraaid. Niet te missen: Playa de los Genoveses (wilde halvemaanbaai), Playa Monsul (zwarte rotsen en de Indiana Jones-duin), de vuurtoren van Cabo de Gata en het Arrecife de las Sirenas rif-uitzicht bij zonsondergang. Basis: het dorp San Jose. Belangrijk: in de zomer (15 jun - 15 sep) is autotoegang tot de stranden beperkt — laat de camper in San Jose en neem de shuttle. Overnachting: Camping Cabo de Gata of area Los Escullos. Minimaal twee nachten — dit is de plek waarvoor men een camper huurt.",
					ru: "На восток по побережью. Остановка в Nerja: Балкон Европы над морем и пещеры с крупнейшим сталактитом мира. Дальше — главная жемчужина юго-востока: природный парк Cabo de Gata-Nijar, единственная пустыня Европы, встречающаяся с морем. Вулканические скалы, кактусы, пляжи без единого здания — здесь снимали вестерны. Обязательно: Playa de los Genoveses (дикая бухта-полумесяц), Playa Monsul (чёрные скалы и дюна из Индианы Джонса), маяк Cabo de Gata и смотровая на рифы Arrecife de las Sirenas на закате. База — деревня San Jose. Важно: летом (15 июня - 15 сентября) въезд к пляжам на машине ограничен — оставляйте автодом в San Jose и берите шаттл. Ночёвка: Camping Cabo de Gata или area Los Escullos. Две ночи минимум — это место, ради которого берут автодом.",
					uk: "На схід уздовж узбережжя. Зупинка в Nerja: Балкон Європи над морем і печери з найбільшим сталактитом у світі. Далі — головна перлина південного сходу: природний парк Cabo de Gata-Nijar, єдина пустеля Європи, що зустрічається з морем. Вулканічні скелі, кактуси, пляжі без жодної будівлі — тут знімали вестерни. Обов'язково: Playa de los Genoveses (дика бухта-півмісяць), Playa Monsul (чорні скелі і дюна з Індіани Джонса), маяк Cabo de Gata і оглядовий майданчик на рифи Arrecife de las Sirenas на заході сонця. База — село San Jose. Важливо: влітку (15 червня - 15 вересня) в'їзд до пляжів на машині обмежений — залишайте автодім у San Jose і беріть шатл. Ночівля: Camping Cabo de Gata або area Los Escullos. Два дні мінімум — це місце, заради якого беруть автодім."
				}
			},
			{
				photoSlot: "dia-8-cartagena",
				title: {
					es: "Dia 8: Cabo de Gata — Cartagena (150 km)",
				...
				text: {
					es: "Por la costa de Murcia hasta Cartagena, ciudad con 3000 anos de historia. Teatro romano descubierto por azar durante unas obras en 1988, fachadas modernistas en la Calle Mayor y el museo naval con el submarino Peral. Noche: area de autocaravanas Cartagena junto al puerto.",
					...
					de: "Entlang der Kueste Murcias nach Cartagena, einer Stadt mit 3.000 Jahren Geschichte. Ein roemisches Theater, das 1988 zufaellig bei Bauarbeiten entdeckt wurde, modernistische Fassaden in der Calle Mayor und das Marinemuseum mit dem U-Boot Peral. Uebernachtung: Area de Autocaravanas Cartagena am Hafen.",
					it: "Lungo la costa di Murcia fino a Cartagena, una citta' con 3.000 anni di storia. Un teatro romano scoperto per caso durante lavori edili nel 1988, facciate moderniste in Calle Mayor e il museo navale con il sottomarino Peral. Pernottamento: area camper Cartagena vicino al porto.",
					nl: "Langs de kust van Murcia naar Cartagena, een stad met 3.000 jaar geschiedenis. Een Romaans theater toevallig ontdekt tijdens bouwwerkzaamheden in 1988, modernistische gevels op Calle Mayor en het marinemuseum met de onderzeeboot Peral. Overnachting: area de autocaravanas Cartagena bij de haven.",
			...
			},
			{
				...
				title: {
					es: "Dias 9-10: Cartagena — Calblanque — Valencia (300 km)",
				...
				text: {
					es: "Por la manana, el secreto para el final: el parque natural Calblanque a 20 minutos de Cartagena. Playas salvajes con dunas doradas que muchos espanoles ni conocen. Pista de tierra desde la carretera — 10 minutos conduciendo con calma. Despues de comer, el tranquilo regreso a casa: menos de 3 horas por la AP-7, a la tarde estais en Valencia. Opcion para 12 dias: un dia en Sevilla despues de Ronda (pero en verano hay +40 grados) o una jornada extra en Cabo de Gata — la mayoria elige lo segundo.",
					en: "Morning: the secret for last — Calblanque natural park 20 minutes from Cartagena. Wild beaches with golden dunes that even many Spaniards don't know. A dirt track from the main road — 10 minutes of careful driving. After lunch, the easy drive home: under 3 hours on the AP-7, back in Valencia by evening. Option for 12 days: a day in Seville after Ronda (but in summer it is +40 degrees) or an extra day in Cabo de Gata — most people choose the latter.",
					de: "Morgens: das Geheimnis fuer den Schluss — der Naturpark Calblanque, 20 Minuten von Cartagena. Wilde Straende mit goldenen Duenen, die sogar viele Spanier nicht kennen. Ein Feldweg von der Hauptstrasse — 10 Minuten ruhige Fahrt. Nach dem Mittagessen die entspannte Rueckfahrt: unter 3 Stunden auf der AP-7, am Abend wieder in Valencia. Option fuer 12 Tage: ein Tag in Sevilla nach Ronda (aber im Sommer sind es +40 Grad) oder ein zusaetzlicher Tag in Cabo de Gata — die meisten waehlen das Zweite.",
					it: "Mattina: il segreto per la fine — il parco naturale Calblanque a 20 minuti da Cartagena. Spiagge selvagge con dune dorate che molti spagnoli non conoscono nemmeno. Una strada sterrata dalla strada principale — 10 minuti di guida tranquilla. Dopo pranzo, il ritorno tranquillo a casa: meno di 3 ore sull'AP-7, la sera siete a Valencia. Opzione per 12 giorni: un giorno a Siviglia dopo Ronda (ma d'estate ci sono +40 gradi) o un giorno extra a Cabo de Gata — la maggior parte sceglie il secondo.",
					nl: "Ochtend: het geheim voor het einde — het natuurpark Calblanque, 20 minuten van Cartagena. Wilde stranden met gouden duinen die zelfs veel Spanjaarden niet kennen. Een onverharde weg vanaf de hoofdweg — 10 minuten rustig rijden. Na de lunch, de rustige rit naar huis: minder dan 3 uur op de AP-7, 's avonds terug in Valencia. Optie voor 12 dagen: een dag in Sevilla na Ronda (maar in de zomer is het +40 graden) of een extra dag in Cabo de Gata — de meeste mensen kiezen het laatste.",
					ru: "Утром — секрет напоследок: природный парк Calblanque в 20 минутах от Картахены. Дикие пляжи с золотыми дюнами, о которых не знают даже многие испанцы. Грунтовка от трассы — 10 минут аккуратной езды. После обеда — спокойный перегон домой: менее 3 часов по AP-7, к вечеру вы в Валенсии. Вариант удлинения до 12 дней: день в Севилье после Ронды (но летом там +40 C) или дополнительная днёвка в Cabo de Gata — большинство выбирает второе.",
					uk: "Вранці — секрет наостанок: природний парк Calblanque в 20 хвилинах від Картахени. Дикі пляжі з золотими дюнами, про які не знають навіть багато іспанців. Ґрунтова дорога від траси — 10 хвилин акуратної їзди. Після обіду — спокійний перегін додому: менш ніж 3 години по AP-7, до вечора ви у Валенсії. Варіант подовження до 12 днів: день у Севільї після Ронди (але влітку там +40 C) або додаткова денна зупинка в Cabo de Gata — більшість вибирає друге."
				}
			}
		],
		tips: [
			{ tip: {
				es: "Presupuesto: para 10 o mas noches se aplica descuento del 10%. Gasolina para 1400 km: unos 180 euros. Las areas del sur son principalmente de pago (8-15 euros), los campings 25-40 euros.",
				...
				de: "Budget: Ab 10 Naechten gilt ein Rabatt von 10 %. Kraftstoff fuer 1.400 km: rund 180 Euro. Stellplaetze im Sueden sind meist kostenpflichtig (8-15 Euro), Campingplaetze 25-40 Euro.",
				it: "Budget: per 10 o piu' notti si applica uno sconto del 10%. Carburante per 1.400 km: circa 180 euro. Le aree del sud sono principalmente a pagamento (8-15 euro), i campeggi 25-40 euro.",
			...
			{ tip: {
				es: "Calor: en verano en Granada y Ronda las visitas van por la manana, siesta a la sombra o en ruta con el aire acondicionado, y la ciudad se anima por la noche. En la costa el calor no se nota.",
				...
				de: "Hitze: Im Sommer in Granada und Ronda Besichtigungen morgens machen, Siesta im Schatten oder auf der Fahrt mit Klimaanlage, abends belebt sich die Stadt. An der Kueste spuert man die Hitze nicht.",
				it: "Calore: d'estate a Granada e Ronda le visite si fanno la mattina, siesta all'ombra o in strada con l'aria condizionata, e la citta' si anima di sera. Sulla costa il caldo non si sente.",
			...
			{ tip: {
				es: "Reservas anticipadas: Alhambra con 2-4 semanas de antelacion (imprescindible), campings de Cabo de Gata en agosto.",
				en: "Book in advance: Alhambra 2-4 weeks ahead (essential), Cabo de Gata campsites in August.",
				de: "Vorausbuchungen: Alhambra 2-4 Wochen im Voraus (unbedingt erforderlich), Campingplaetze in Cabo de Gata im August.",
			...
			{ tip: {
				es: "Agua: en el sur los puntos de agua son mas escasos que en el norte — rellenad el deposito en cada oportunidad. Todos los puntos en Park4Night.",
				...
				de: "Wasser: Im Sueden sind Wasserpunkte seltener als im Norden — Wasserbehaelter bei jeder Gelegenheit fuellen. Alle Punkte auf Park4Night.",
				it: "Acqua: al sud i punti acqua sono piu' rari che al nord — riempite il serbatoio ad ogni occasione. Tutti i punti su Park4Night.",
			...
			{ tip: {
				es: "Carreteras: el unico tramo realmente de montana es la Alpujarra. Si teneis dudas, saltaos el dia 3 y id desde Granada directamente a Ronda por la autopista.",
				...
				de: "Strassen: Der einzige wirklich bergige Abschnitt ist die Alpujarra. Im Zweifelsfall Tag 3 auslassen und von Granada direkt per Autobahn nach Ronda fahren.",
				it: "Strade: l'unico tratto veramente montano e' l'Alpujarra. Se avete dubbi, saltate il giorno 3 e andate da Granada direttamente a Ronda in autostrada.",
		...
		ctaText: {
			es: "Nuestro McLouis Yearling 89G es el companero perfecto para Andalucia: aire acondicionado para el verano del sur, panel solar para las noches autonomas en Cabo de Gata, 7,4 metros compactos para los pueblos de montana y 3 sillas de playa para las calas salvajes.",
			en: "Our McLouis Yearling 89G is the perfect companion for Andalusia: air conditioning for the southern summer, a solar panel for self-sufficient nights in Cabo de Gata, a compact 7.4 metres for mountain villages and 3 beach chairs for wild coves.",
			de: "Unser McLouis Yearling 89G ist der ideale Begleiter fuer Andalusien: Klimaanlage fuer den suedlichen Sommer, Solarpanel fuer autonome Naechte in Cabo de Gata, kompakte 7,4 Meter fuer die Bergdoerfer und 3 Strandsessel fuer wilde Buchten.",
			it: "Il nostro McLouis Yearling 89G e' il compagno perfetto per l'Andalusia: aria condizionata per l'estate del sud, pannello solare per le notti autonome a Cabo de Gata, 7,4 metri compatti per i borghi di montagna e 3 sedie da spiaggia per le calette selvagge.",
			nl: "Onze McLouis Yearling 89G is de perfecte metgezel voor Andalusie: airconditioning voor de zuidelijke zomer, zonnepaneel voor autonome nachten in Cabo de Gata, compacte 7,4 meter voor bergdorpen en 3 strandstoelen voor wilde baaien.",
			ru: "Наш McLouis Yearling 89G — идеальный компаньон для Андалусии: кондиционер для южного лета, солнечная панель для автономных ночёвок в Cabo de Gata, компактные 7,4 метра для горных деревень и 3 пляжных кресла для диких бухт.",
			uk: "Наш McLouis Yearling 89G — ідеальний супутник для Андалусії: кондиціонер для південного літа, сонячна панель для автономних ночівель у Cabo de Gata, компактні 7,4 метра для гірських сіл і 3 пляжні крісла для диких бухт."
		},
		ctaButton: {
			es: "Reservar fechas",
			en: "Book your dates",
...
var $$splitNotFoundComponentImporter = () => import("./rutas._slug-CpXWLup8.mjs");
var $$splitComponentImporter = () => import("./rutas._slug-BfZxX2TD.mjs");
var Route = createFileRoute("/rutas/$slug")({
	head: ({ params }) => {
		...
		return {
			meta: [
				...
				{
					name: "description",
					content: route.metaDescription.es
				},
				{
					property: "og:title",
					content: route.metaTitle.es
				},
				{
