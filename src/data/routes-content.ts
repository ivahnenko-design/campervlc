...
const andalucia: RouteContent = {
  ...
  intro: {
    es: "Andalucia es la Espana de las peliculas: flamenco, palacios moros, gargantas con casas blancas y sol interminable. Pero hay otra Andalucia: las calas salvajes del parque natural de Cabo de Gata, los serpentines de montana de la Alpujarra, los pueblos pesqueros donde el tiempo se detuvo. La autocaravana abre las dos. La ruta discurre en circuito por Granada, Ronda, la costa de Malaga y de vuelta a lo largo del mar por Almeria y Cartagena. Unos 1400 km a ritmo tranquilo, con dias de descanso en playas. Viajar en autocaravana por andalucia — la mejor forma de ver la otra cara del sur. Mejor epoca: abril-junio y septiembre-octubre; en verano los dias calurosos del circuito se pasan junto al mar.",
    en: "Andalusia is the Spain of films: flamenco, Moorish palaces, gorges lined with white houses and endless sunshine. But there is another Andalusia: the wild coves of the Cabo de Gata natural park, the mountain switchbacks of the Alpujarra, the fishing villages where time stood still. A motorhome opens both. The route runs in a loop through Granada, Ronda, the Malaga coast and back along the sea via Almeria and Cartagena. Around 1,400 km at a relaxed pace, with rest days on beaches. Best time: April to June and September to October; in summer the hot inland days are spent at the coast.",
    de: "Andalusien ist das Spanien der Filme: Flamenco, maurische Palaeste, Schluchten mit weissen Haeusern und endlose Sonne. Aber es gibt ein anderes Andalusien: die wilden Buchten des Naturparks Cabo de Gata, die Gebirgsserpentinen der Alpujarra, die Fischerdoerfer, in denen die Zeit stehen blieb. Das Wohnmobil oeffnet beide. Die Route fuehrt im Rundkurs durch Granada, Ronda, die Kueste von Malaga und entlang des Meeres zurueck ueber Almeria und Cartagena. Rund 1.400 km in entspanntem Tempo, mit Ruhetagen am Strand. Beste Reisezeit: April bis Juni und September bis Oktober; im Sommer verbringt man die heissen Binnentage am Meer.",
    it: "L'Andalusia e' la Spagna dei film: flamenco, palazzi moreschi, gole con case bianche e sole senza fine. Ma c'e' un'altra Andalusia: le calette selvagge del parco naturale di Cabo de Gata, i tornanti di montagna delle Alpujarras, i villaggi di pescatori dove il tempo si e' fermato. Il camper apre entrambe. Il percorso si svolge in circolo attraverso Granada, Ronda, la costa di Malaga e di ritorno lungo il mare via Almeria e Cartagena. Circa 1.400 km a ritmo rilassato, con giorni di riposo sulle spiagge. Periodo migliore: aprile-giugno e settembre-ottobre; d'estate le giornate calde dell'entroterra si trascorrono in riva al mare.",
    nl: "Andalusie is het Spanje van de films: flamenco, Moorse paleizen, kloven met witte huizen en eindeloze zon. Maar er is een ander Andalusie: de wilde baaien van het natuurpark Cabo de Gata, de bergwegen van de Alpujarra, de vissersdorpen waar de tijd heeft stilgestaan. Een camper opent beide. De route loopt in een lus door Granada, Ronda, de kust van Malaga en langs de zee terug via Almeria en Cartagena. Ongeveer 1.400 km in een rustig tempo, met rustdagen op stranden. Beste tijd: april tot juni en september tot oktober; in de zomer brengt men de hete dagen op het platteland door aan de kust.",
    ru: "Андалусия — это Испания из фильмов: фламенко, мавританские дворцы, ущелья с белыми домами и бесконечное солнце. Но есть и другая Андалусия: дикие бухты природного парка Cabo de Gata, горные серпантины Альпухарры, рыбацкие деревни, где время остановилось. Автодом открывает обе. Маршрут построен кольцом через Гранаду, Ронду, побережье Малаги и обратно вдоль моря через Альмерию и Картахену. Около 1400 км в спокойном темпе, с днёвками на пляжах. Лучшее время: апрель-июнь и сентябрь-октябрь; летом жаркие дни маршрут проводит у моря.",
    uk: "Андалусія — це Іспанія з кіно: фламенко, мавританські палаци, ущелини з білими будинками і нескінченне сонце. Але є й інша Андалусія: дикі бухти природного парку Cabo de Gata, гірські серпантини Альпухарри, рибальські села, де час зупинився. Автодім відкриває обидві. Маршрут побудований кільцем через Гранаду, Ронду, узбережжя Малаги і назад вздовж моря через Альмерію та Картахену. Близько 1400 км у спокійному темпі, з денними зупинками на пляжах. Найкращий час: квітень-червень і вересень-жовтень; влітку спекотні дні маршрут проводить біля моря.",
  },
  days: [
    {
